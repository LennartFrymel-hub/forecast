...
| df_pipeline        | [pd](`pandas`).[DataFrame](`pandas.DataFrame`)                                  | DataFrame with a tz-aware :class:`~pandas.DatetimeIndex` containing all target columns produced by the preprocessing pipeline.                                                                                                                                                                                                                                                                                    | _required_ |
...
|        | [Optional](`typing.Optional`)\[[pd](`pandas`).[DataFrame](`pandas.DataFrame`)\]                                                                                                                                                       | - **y_train** — 1-D Series with the target values over the training window ``[config.start_train_ts, config.end_train_ts]``, squeezed to a plain :class:`~pandas.Series`.                  |
