# model_selection.split_ts_cv { #spotforecast2_safe.model_selection.split_ts_cv }
...
| Name | Description |
| --- | --- |
| [TimeSeriesFold](#spotforecast2_safe.model_selection.split_ts_cv.TimeSeriesFold) | Class to split time series data into train and test folds. |

### TimeSeriesFold { #spotforecast2_safe.model_selection.split_ts_cv.TimeSeriesFold }
...
| Name | Description |
| --- | --- |
| [split](#spotforecast2_safe.model_selection.split_ts_cv.TimeSeriesFold.split) | Split the time series data into train and test folds. |

##### split { #spotforecast2_safe.model_selection.split_ts_cv.TimeSeriesFold.split }
