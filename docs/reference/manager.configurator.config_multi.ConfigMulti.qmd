...
| data_source              | [str](`str`)                                                                                         | Primary data file name (e.g. ``"data_in.csv"``). Defaults to ``"data_in.csv"``.                                                                                                                                                                                                                                                                                                                                                             | `'data_in.csv'`             |
| data_test                | [str](`str`)                                                                                         | Test data file name (e.g. ``"data_test.csv"``). Defaults to ``"data_test.csv"``.                                                                                                                                                                                                                                                                                                                                                            | `'data_test.csv'`           |
...
| cache_data               | [bool](`bool`)                                                                                       | If ``True``, cache intermediate data to disk. Defaults to ``False``.                                                                                                                                                                                                                                                                                                                                                                        | `False`                     |
...
| data_home                | [Optional](`typing.Optional`)\[[Any](`typing.Any`)\]                                                 | Path to the data directory. ``None`` means the library default (``~/spotforecast2_data/``) is used.                                                                                                                                                                                                                                                                                                                                         | `None`                      |
...
| data_source              | [str](`str`)                                                                    | Primary data file name.                                                                                                                                         |
| data_test                | [str](`str`)                                                                    | Test data file name.                                                                                                                                            |
...
| cache_data               | [bool](`bool`)                                                                  | Cache intermediate data toggle.                                                                                                                                 |
| cache_home               | [Optional](`typing.Optional`)\[[Any](`typing.Any`)\]                            | Path to the cache directory.                                                                                                                                    |
| data_home                | [Optional](`typing.Optional`)\[[Any](`typing.Any`)\]                            | Path to the data directory.                                                                                                                                     |
