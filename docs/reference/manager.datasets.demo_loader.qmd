# manager.datasets.demo_loader { #spotforecast2_safe.manager.datasets.demo_loader }
...
| Name | Description |
| --- | --- |
| [load_actual_combined](#spotforecast2_safe.manager.datasets.demo_loader.load_actual_combined) | Load ground truth and compute combined actual series with validation. |

### load_actual_combined { #spotforecast2_safe.manager.datasets.demo_loader.load_actual_combined }
...
|------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|------------|
| config           | [DemoConfig](`spotforecast2_safe.manager.datasets.demo_data.DemoConfig`)   | Configuration object containing default paths and parameters.                                       | _required_ |
