# manager.exo.weather.get_weather_features { #spotforecast2_safe.manager.exo.weather.get_weather_features }
...
| cached              | [bool](`bool`)                                                                          | If ``True``, read from the local weather cache before issuing a network request.  Defaults to ``True``.                                                               | `True`     |
