# manager.exo.calendar.get_holiday_features { #spotforecast2_safe.manager.exo.calendar.get_holiday_features }
...
| tz               | [str](`str`)                                                                            | Timezone applied to the generated index and passed to :func:`~spotforecast2_safe.data.fetch_data.fetch_holiday_data`. Defaults to ``"UTC"``.        | `'UTC'`    |
