...
- API documentation is auto-generated from docstrings via quartodoc into `docs/reference/`
- Processing guides go in `docs/processing/`
- Preprocessing guides go in `docs/preprocessing/`
- Use Google-style docstrings for all public API

Build documentation locally:

```bash
uv run python docs/quartodoc_build.py  # generate API reference stubs
quarto preview                          # preview at http://localhost:4786
```
...
- Review the [Safety Documentation](docs/safe/spotforecast2-safe.qmd)
