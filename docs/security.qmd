...
4. Review [MODEL_CARD.md](safe/MODEL_CARD.qmd) for safety-critical considerations
...
5. Follow contribution guidelines in [CONTRIBUTING.md](contributing.qmd)
...
- EU AI Act Ready: Support for compliance via [MODEL_CARD.md](safe/MODEL_CARD.qmd)
...
- [Model/Method Card](safe/MODEL_CARD.qmd) - System design and compliance documentation
- [Contributing Guide](contributing.qmd) - How to contribute safely
